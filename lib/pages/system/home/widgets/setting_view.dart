 ...
 * @LastEditTime: 2023-07-20 17:14:05
...
class _SettingViewState extends State<SettingView> {
  ...
  Widget build(BuildContext context) {
    return ScaffoldPage.scrollable(children: [
      ...
      Wrap(children: [
        // Tooltip(
        //   child: _buildColorBlock(Colors.blue, 'Blue'),
      ...
      20.verticalSpacingRadius,
      Text('菜单栏模式', style: FluentTheme.of(context).typography.subtitle),
      5.verticalSpacingRadius,
      Divider(),
      5.verticalSpacingRadius,
      ...List.generate(navigationIndicatorNames.length, (index) {
        final mode = navigationIndicatorNames[index];
        return Padding(
          padding: const EdgeInsetsDirectional.only(bottom: 8.0),
          child: RadioButton(
            checked: GlobalTheme.instance.navigationIndicator == mode,
            onChanged: (value) {
              if (value) GlobalTheme.instance.navigationIndicator = mode;
            },
            content: Text(
